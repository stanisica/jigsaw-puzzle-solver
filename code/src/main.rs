...
fn main() {
    ...
    util::load_parts_1(&mut parts, "../images/example_1/parts_1/");
    //util::load_parts_2(&mut parts, "../images/example_1/parts_2/");

    let image_pix: Vec<Vec<(u8, u8, u8)>> = util::image_to_pixel_matrix(&image);
    //util::print_matrix_portion(&image_pix, 4);
